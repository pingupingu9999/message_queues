...
#define MAX_NUM_MESSAGES_PER_MSGQUEUE 128
#define MAX_NUM_STRINGS 32768
#define MAX_NUM_MSGQUEUES 256 // MAX_NUM_STRINGS/MAX_NUM_MESSAGES_PER_MSGQUEUE
...
#define DSOS_CALL_WAKEUP_MSGQUEUE  13
#define DSOS_CALL_OPEN_MSGQUEUE  14
...
#define ATT_MSGQUEUE_CURRENT_MESSAGES 0
#define ATT_MSGQUEUE_MAX_MESSAGES 1
#define ATT_MSGQUEUE_MESSAGE_SIZE 2
#define ATT_MSGQUEUE_OPENINGS 3
#define ATT_MSGQUEUE_UNLINK_REQUEST 4

// queue debug
#define PRINT_MSGQUEUE_MESSAGES 0
#define PRINT_MSGQUEUE_READERS 1
#define PRINT_MSGQUEUE_WRITERS 1
#define PRINT_MSGQUEUE_NONBLOCK 1
#define PRINT_MSGQUEUE_ATTRIBUTES 1
